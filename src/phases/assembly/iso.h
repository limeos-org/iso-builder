 ...
 *
 * Uses grub-mkrescue to create an ISO that supports both UEFI and legacy BIOS
 * boot.
 *
 ...
 * @return - `-2` - Indicates boot files copy failure.
 * @return - `-3` - Indicates GRUB setup failure.
 * @return - `-4` - Indicates squashfs creation failure.
